...
if __name__ == '__main__':
    ...
    parser.add_argument('--index', type=str, default='./data/bindingmoad/pocket_10/index_seq.pkl')
    ...
    if args.index:
        ...
        train_id = [i for i in range(len(name_id_dict)-100)]
        test_id = [i for i in range(len(name_id_dict) - 100, len(name_id_dict))]
        val_id = []
